...
int _close(int);
/**
 * main - a main function that copies the content of a file to another file.
...
/**
 * _close - a function that closes a file and prints error on failure
 * @description: description error for closed file
 * Return: 1 on success, -1 on failure
 */
int _close(int description)
{
	int error;
